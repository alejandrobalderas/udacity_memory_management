...
{
    // TASK 1
    // _chatLogic is now a smart pointer and thus its memory will be free when ChatBotPanelDialog goes out of scope
    // the following command was delated: delete _chatLogic;
}
